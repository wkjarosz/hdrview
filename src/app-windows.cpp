                               ...
                               float width = 0.f)
{
    ...
    {
        float next_split = std::max((float)(int)(w_items * (components - 1 - c) / components), 1.f);
        ImGui::SetNextItemWidth(std::max(prev_split - next_split, 1.0f));
    ...
    {
        ImGui::SetNextItemWidth((float)(int)(w_full));
