...
json entry_to_json(void *entry_v, int boi, unsigned int ifd_idx_i)
{
    ...
    case 5123: // DynamicRangeSetting (0x1402)
        tag_name = "Fuji Dynamic Range Setting";
        switch (value["value"].get<int>())
        {
        case 0x0: value["string"] = "Auto"; break;
