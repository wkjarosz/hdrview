...
//! Names of the encoders offered for `codec`, in the order the save dialog lists them. Empty when the
//! libheif build has none: distributions package each codec separately, so reading doesn't imply writing.
