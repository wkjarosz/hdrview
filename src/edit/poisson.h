...
/// The discrete Laplacian of \p src (eight-neighbor form), reading past its edges by clamping.
/**
    The same operator the solve inverts, so it also produces the guidance field.
*/
