...
void create_dither_texture()
{
    try
    {
        ...
        g_dither_texture = DataBuffer{stbi_load_from_memory((const stbi_uc *)source.data(), (int)source.size(), &width,
                                                            &height, &channels_in_file, 1),
                                      deleter};
    ...
    catch (const std::exception &e)
    {
        ...
        static const uint8_t bayer[16][16] = {
